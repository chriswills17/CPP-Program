...
//create the menu for user selection
void DrawMenu() {
    ...
    while (menuLoop != 4) {
        ...
        case 1:
            ...
            std::cout << std::endl;                           //Add some space in between the printed list and menu
            break;
        ...
        case 2:
            ...
            //Case 3: Print histogram based on how many times each item appears. 
        case 3:
            system("CLS");                                          
